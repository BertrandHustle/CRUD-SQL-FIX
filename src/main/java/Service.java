...
public class Service {
    ...
    public void insertForm(Form form) throws SQLException{
        ...
        //sets form.id to autogenerated id from SQL
        ResultSet resultSet = preparedStatement.getGeneratedKeys();
        resultSet.next();
    ...
    public Form selectForm(int id) throws SQLException{
        PreparedStatement statement = connection.prepareStatement("SELECT * FROM form INNER JOIN user ON user.id = form.Id WHERE form.Id = ?");
